...
from .config import BASE_URL, GRID_TYPES, GRID_URL_MAP, URL_LISTING, URL_STATS, URL_RESULTS, DELAY_LISTING
...
def fetch_listing_page(session, grid_type, page):
    url_key = GRID_URL_MAP[grid_type]
    url = URL_LISTING.format(base=BASE_URL, grid=url_key, page=page)
